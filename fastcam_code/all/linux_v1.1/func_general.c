...
void ServerParamSolve(int socket, unsigned char* buffer_recv, int frame_length_total)
{
    ...
    {
        save_CamPIR_int("mode", buffer_recv[12]);
    ...
    {
        save_CamPIR_int("picturesize", buffer_recv[12]);
    ...
    {
        save_CamPIR_int("videosize", buffer_recv[12]);
    ...
    {
        save_CamPIR_int("pictimes", buffer_recv[12]);
    ...
    {
        save_CamPIR_int("videotimes", buffer_recv[12]);
    ...
    {
        save_CamPIR_int("gaptimes", buffer_recv[12]);
    ...
    {
        save_CamPIR_int("sensitivity", buffer_recv[12]);
    ...
    {
        save_CamPIR_int("timestamp", buffer_recv[12]);
